...
const footerList = footerElement === null || footerElement === void 0 ? void 0 : footerElement.querySelector('ul');
const generateFooterControls = (view) => {
    if (!footerList || !footerControls.hasOwnProperty(view))
        return;
    for (const control of footerControls[view]) {
